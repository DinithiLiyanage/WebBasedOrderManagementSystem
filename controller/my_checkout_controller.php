...
switch($status)
{
    case "checkout":
        ...
        if(isset($_SESSION["cart"])){
            ...
            for($x=0; $x<$arrLen ; $x++){
                $order_itemid = $orderObj ->addOrderItems($order_id, $_SESSION["cart"][$x]);
        ...
        if($method == "delivery")
        {
            ...
            $delivery_id = $orderObj ->addDeliveryOrder($order_id, $d_fname, $d_lname, $d_address, $d_city, $d_cno1);
        ...
        if($method == "pickup")
        {
            ...
            $pickup_id = $orderObj ->addPickupOrder($order_id, $p_fname, $p_lname, $p_time);
