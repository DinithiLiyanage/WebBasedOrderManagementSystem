...
<html>
        ...
        <div class="container-fluid">
            ...
            <div class="row" >
                ...
                <div class="col-md-6" >
                    ...
                    <form action="../controller/my_menu_controller.php?status=editcart" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn btn-block addItem" id="addItem" style="background-color:#808080; color:#FFFFFF;">Edit item in cart</button>
                            </div>
                        </div>
    ...
    <script src="../js/my_edit_cart_validations.js" ></script>
